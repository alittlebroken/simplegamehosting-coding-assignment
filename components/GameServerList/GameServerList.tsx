...
const GameServerList: FC<GameServerListProps> = ({data, title}) => {
  ...
  return (
    ...
    <h1 className="text-3xl font-bold text-purple-800 sm:text-5xl dark:text-purple-400">{title}</h1>
      <article className="grid grid-cols-1 row-start-2 gap-5 bg-slate-300 p-3 rounded-lg text-slate-500 sm:grid-cols-2 md:grid-cols-3 dark:text-sky-200 dark:bg-slate-800">
        {data.map(item => {
          return (
